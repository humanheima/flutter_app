...
可以在 https://github.com/hongyangAndroid/xueandroid 项目中以issue的形式提出，我将及时跟进。''',
                  ...
                  Text(
                    "    本应用是使用Flutter开发的WanAndroid网站的Android客户端，由于初入Flutter，难免有bug，如果你发现任何问题，不要犹豫，马上在issue中提交。你的关注是我前进的动力！",
                    style: contentStyle,
                  ),
                ],
              ),
            ...
            ListTile(
              title: Text("源代码"),
              subtitle:
                  Text("https://github.com/shijiacheng/wanandroid_flutter"),
              onTap: () {
                RouteUtil.toWebView(context, "github.com/shijiacheng",
                    "https://github.com/shijiacheng/wanandroid_flutter");
              },
            ),
            ListTile(
              title: Text("版权声明"),
