class ProjectListBean {
  ...
  ProjectListBean.fromJson(Map<String, dynamic> json) {
    data = json['data'] != null ? ProjectList.fromJson(json['data']) : null;
...
class ProjectList {
  ...
  ProjectList({this.curPage, this.datas, this.offset, this.over, this.pageCount, this.size, this.total});

  ProjectList.fromJson(Map<String, dynamic> json) {
    curPage = json['curPage'];
    if (json['datas'] != null) {
      datas = (json['datas'] as List).map((v) => Project.fromJson(v)).toList();
    }
    offset = json['offset'];
    over = json['over'];
